...
/*   Updated: 2024/11/26 10:27:22 by hait-sal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::pair<vi, di> check_args(char **argv) {
    vi  vec;
    di  deq;
    double nbr;
    int i = 1;
...
int main(int ac, char **av) {
    try {
        ...
        std::cout << "ac -> " << ac << av[0] << std::endl;
        // std::vector<string> argv = av;
        // std::pair<vi, di> input = check_args(av);
        // print_str(av[1], "av[1]:  ");
        // vi vec = input.first;
        vi vec;
        vec.push_back(42109);
